...
public class MainApp {
    ...
    private static void listAllIncomingTransactions() {
        ...
        System.out.println(
            "\n==========================================================================================================================================================================");
        System.out.println(
            "                                              ALL INCOMING TRANSACTIONS (PROFESSIONAL DASHBOARD)");
        System.out.println(
            "==========================================================================================================================================================================");

        // ✅ COLUMN HEADERS
        System.out.printf(
            "%-5s %-25s %-25s %-25s %-10s %15s %-15s %-20s\n",
            "No",
            "REFERENCE NO",
            "SENDER BANK",
            "RECEIVER BANK",
        ...
        for (IncomingTransaction txn : txns) {
            ...
            String time = (txn.getIngestTimestamp() != null)
                    ? txn.getIngestTimestamp().format(formatter)
                    : "N/A";

            System.out.printf(
                "%-5d %-25s %-25s %-25s %-10s %15.2f %-15s %-20s\n",
                i++,
                txn.getSourceRef(),
